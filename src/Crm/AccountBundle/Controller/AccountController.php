...
class AccountController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CrmAccountBundle:Account')->findAll();
     ...
     * @Method("POST")
     * @Template("CrmAccountBundle:Account:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CrmAccountBundle:Account')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CrmAccountBundle:Account:edit.html.twig")
     */
