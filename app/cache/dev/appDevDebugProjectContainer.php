...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'crm', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager527536ffb73f8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager527536ffb73f8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_527536ffb73f8.php';
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/Symfony/src/Crm/AccountBundle/Entity', 1 => '/var/www/Symfony/src/Acme/StoreBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Crm\\AccountBundle\\Entity');
        $f->addDriver($e, 'Acme\\StoreBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('CrmAccountBundle' => 'Crm\\AccountBundle\\Entity', 'AcmeStoreBundle' => 'Acme\\StoreBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager527536ffb73f8_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/Symfony/src/Crm/AccountBundle/Resources/views', 'CrmAccount');
        $instance->addPath('/var/www/Symfony/src/Acme/StoreBundle/Resources/views', 'AcmeStore');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CrmAccountBundle' => 'Crm\\AccountBundle\\CrmAccountBundle',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_527536ffb73f8.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager527536ffb73f8_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
